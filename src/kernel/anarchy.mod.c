...
KSYMTAB_DATA(anarchy_thunderbolt_driver, "_gpl", "");
...
SYMBOL_CRC(tb_read32, 0xc5826327, "_gpl");
SYMBOL_CRC(tb_write32, 0xd767d124, "_gpl");
SYMBOL_CRC(anarchy_tb_init, 0xe3f9a353, "_gpl");
SYMBOL_CRC(anarchy_tb_fini, 0x8232af10, "_gpl");
...
SYMBOL_CRC(anarchy_thunderbolt_driver, 0xc0acf110, "_gpl");
...
SYMBOL_CRC(anarchy_ring_init, 0xd3a5a9bb, "_gpl");
SYMBOL_CRC(anarchy_ring_cleanup, 0x3055a5d6, "_gpl");
SYMBOL_CRC(anarchy_ring_start, 0xfe3e3f50, "_gpl");
SYMBOL_CRC(anarchy_ring_stop, 0xc10146a0, "_gpl");
SYMBOL_CRC(anarchy_ring_transfer, 0xa4a06918, "_gpl");
SYMBOL_CRC(anarchy_ring_complete, 0xe0298b5d, "_gpl");
SYMBOL_CRC(init_game_compatibility, 0x671865da, "_gpl");
SYMBOL_CRC(cleanup_game_compatibility, 0x42ac71d3, "_gpl");
SYMBOL_CRC(init_game_specific, 0xa94d00c9, "_gpl");
SYMBOL_CRC(setup_game_memory_region, 0xf308d7e8, "_gpl");
SYMBOL_CRC(cleanup_game_memory_region, 0xd1013bb7, "_gpl");
SYMBOL_CRC(init_thermal_monitoring, 0xbe7b3519, "_gpl");
SYMBOL_CRC(cleanup_thermal_monitoring, 0x55b1b592, "_gpl");
SYMBOL_CRC(anarchy_hotplug_init, 0x2eaa8b3a, "_gpl");
SYMBOL_CRC(anarchy_hotplug_exit, 0xb07eda8e, "_gpl");
SYMBOL_CRC(anarchy_power_init, 0xd4fbc475, "_gpl");
SYMBOL_CRC(anarchy_power_exit, 0x2c1ba1a0, "_gpl");
SYMBOL_CRC(anarchy_power_set_profile, 0xa594076f, "_gpl");
SYMBOL_CRC(anarchy_power_get_profile, 0x4f5b8381, "_gpl");
SYMBOL_CRC(anarchy_power_set_fan_speed, 0x4343d781, "_gpl");
SYMBOL_CRC(anarchy_power_set_power_limit, 0x424632c8, "_gpl");
SYMBOL_CRC(anarchy_optimize_for_game, 0x67c4b91d, "_gpl");
SYMBOL_CRC(anarchy_dma_set_device_priority, 0xdaffef5a, "_gpl");
SYMBOL_CRC(anarchy_dma_transfer, 0xd6d6c801, "_gpl");
SYMBOL_CRC(anarchy_dma_transfer_priority, 0x08e14ad8, "_gpl");
SYMBOL_CRC(anarchy_dma_cleanup, 0xc4c187fe, "_gpl");
SYMBOL_CRC(anarchy_dma_device_start_transfer, 0xe6113082, "_gpl");
SYMBOL_CRC(anarchy_dma_device_set_burst_size, 0xe305f8ce, "_gpl");
SYMBOL_CRC(anarchy_dma_device_set_queue_depth, 0xb15d8baf, "_gpl");
SYMBOL_CRC(anarchy_dma_device_enable_prefetch, 0x0446b6cd, "_gpl");
SYMBOL_CRC(anarchy_dma_device_set_write_combining, 0xb3dd8e42, "_gpl");
SYMBOL_CRC(init_command_processor, 0xf62c59bc, "_gpl");
SYMBOL_CRC(cleanup_command_processor, 0xfcf157b5, "_gpl");
SYMBOL_CRC(process_game_command, 0x8da12c8a, "_gpl");
SYMBOL_CRC(optimize_command_processing, 0xbfb989c5, "_gpl");
SYMBOL_CRC(anarchy_pcie_init, 0x440316dc, "_gpl");
SYMBOL_CRC(anarchy_pcie_exit, 0x3f64b632, "_gpl");
SYMBOL_CRC(anarchy_pcie_disable, 0x19253971, "_gpl");
SYMBOL_CRC(pcie_link_is_up, 0x92040dd1, "_gpl");
SYMBOL_CRC(anarchy_pcie_cleanup_state, 0xd353e16a, "_gpl");
SYMBOL_CRC(anarchy_pcie_handle_error, 0x1d66348c, "_gpl");
SYMBOL_CRC(anarchy_pcie_init_state, 0xbc67bc2a, "_gpl");
SYMBOL_CRC(anarchy_pcie_enable_link, 0x917fb2c4, "_gpl");
SYMBOL_CRC(anarchy_pcie_get_bandwidth_usage, 0xc1c057fa, "_gpl");
SYMBOL_CRC(anarchy_device_init, 0xa22610af, "_gpl");
SYMBOL_CRC(anarchy_device_exit, 0xeb4e1b9b, "_gpl");
SYMBOL_CRC(anarchy_device_suspend, 0x57f2c88e, "_gpl");
SYMBOL_CRC(anarchy_device_resume, 0x427aba98, "_gpl");
SYMBOL_CRC(anarchy_gpu_get_clock, 0x7644e8c3, "_gpl");
SYMBOL_CRC(anarchy_gpu_get_mem_clock, 0xc2565ad4, "_gpl");
SYMBOL_CRC(anarchy_gpu_get_power, 0x20bb922b, "_gpl");
SYMBOL_CRC(anarchy_gpu_get_temp, 0x262dd396, "_gpl");
SYMBOL_CRC(anarchy_gpu_get_fan, 0x4b30a6dc, "_gpl");
SYMBOL_CRC(anarchy_gpu_get_util, 0x838c5aff, "_gpl");
SYMBOL_CRC(anarchy_gpu_get_mem_util, 0x9a807a03, "_gpl");
SYMBOL_CRC(anarchy_gpu_get_vram_used, 0x5bd2e74c, "_gpl");
SYMBOL_CRC(anarchy_gpu_set_fan_speed, 0x8edee083, "_gpl");
SYMBOL_CRC(anarchy_gpu_emu_set_power_limit, 0xd1d53a6a, "_gpl");
SYMBOL_CRC(anarchy_gpu_set_clocks, 0x630d7e37, "_gpl");
SYMBOL_CRC(anarchy_gpu_emu_init, 0x8e147acf, "_gpl");
SYMBOL_CRC(anarchy_gpu_emu_exit, 0xbe41f600, "_gpl");
SYMBOL_CRC(anarchy_gpu_emu_start, 0x49ff82a4, "_gpl");
SYMBOL_CRC(anarchy_gpu_emu_stop, 0x6471c88a, "_gpl");
SYMBOL_CRC(anarchy_gpu_emu_handle_mmio, 0x07d5f352, "_gpl");
SYMBOL_CRC(anarchy_gpu_emu_map_memory, 0xaab33980, "_gpl");
SYMBOL_CRC(anarchy_perf_exit, 0xbc28cc40, "_gpl");
SYMBOL_CRC(anarchy_perf_init, 0xc74f6cae, "_gpl");
SYMBOL_CRC(anarchy_perf_start, 0xa2af1e56, "_gpl");
SYMBOL_CRC(anarchy_perf_stop, 0x12dbc24c, "_gpl");
SYMBOL_CRC(anarchy_perf_get_state, 0x8ca5af63, "_gpl");
SYMBOL_CRC(init_performance_monitoring, 0x28b709ab, "_gpl");
SYMBOL_CRC(cleanup_performance_monitoring, 0x98985af1, "_gpl");
SYMBOL_CRC(anarchy_service_probe, 0x514d04e8, "_gpl");
SYMBOL_CRC(anarchy_service_remove, 0x00a49eae, "_gpl");
SYMBOL_CRC(anarchy_gpu_set_power_limit, 0xda850109, "_gpl");
SYMBOL_CRC(anarchy_gpu_get_power_limit, 0x95f27790, "_gpl");
SYMBOL_CRC(anarchy_gpu_power_down, 0xfdfea259, "_gpl");
SYMBOL_CRC(anarchy_gpu_power_up, 0xd8d87c9f, "_gpl");
